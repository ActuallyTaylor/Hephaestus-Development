//
//  RenderImageAsView.swift
//  LowData World Builder
//
//  Created by Zachary lineman on 3/27/22.
//

import SwiftUI

extension View {
    func renderAsImage(width: CGFloat, height: CGFloat) -> NSImage? {
        let view = NoInsetHostingView(rootView: self)
        view.setFrameSize(view.fittingSize)
        return view.bitmapImage()?.crop(toSize: NSSize(width: width, height: height))
    }
